...
export default () => {
  ...
  return {
    ...
    body: {
      ...
      admin_graphql_api_id: `gid://shopify/Order/${Math.floor(Math.random() * 1000000000000000)}`,
      app_id: null,
      browser_ip: null,
      ...
      currency: "USD",
      current_subtotal_price: itemPrice,
      current_subtotal_price_set: {
        shop_money: { amount: itemPrice, currency_code: "USD" },
        presentment_money: { amount: itemPrice, currency_code: "USD" }
      },
      ...
      tags: [
        ...
        'promotional-order',
        'holiday-sale'
      ].slice(0, Math.floor(Math.random() * 3) + 1).join(', '),
      tax_exempt: false,
      tax_lines: [],
      ...
      total_discounts_set: {
        shop_money: { amount: discountAmount, currency_code: "USD" },
        presentment_money: { amount: discountAmount, currency_code: "USD" }
      },
      ...
      customer: {
        ...
        created_at: null,
        updated_at: null,
        first_name: ['John', 'Jane', 'Mike', 'Sarah', 'Chris'][Math.floor(Math.random() * 5)],
      ...
      line_items: [
        {
          id: Math.floor(Math.random() * 1000000000000000),
          admin_graphql_api_id: `gid://shopify/LineItem/${Math.floor(Math.random() * 1000000000000000)}`,
          attributed_staffs: [
            {
      ...
      shipping_lines: [
        {
          ...
          price: shippingPrice,
          price_set: {
            shop_money: { amount: shippingPrice, currency_code: "USD" },
            presentment_money: { amount: shippingPrice, currency_code: "USD" }
          },
